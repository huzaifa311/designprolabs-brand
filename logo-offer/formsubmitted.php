...
<html lang="en">
  <head>
    ...
    <script>
      gtag('set', 'user_data', {
"sha256_email_address": localStorage.getItem("email"),
"sha256_phone_number": localStorage.getItem("phone"),
"address": {
"address.sha256_first_name": null,
"address.sha256_last_name": null,
"city": null,
"region": null,
"postal_code": null,
"country": null
  ...
  <body>
    ...
    <noscript
      ><iframe
        src="https://www.googletagmanager.com/ns.html?id=GTM-MNFGZBVL"
        height="0"
        width="0"
    ...
    >
      ...
      <a
        href="tel:+17379103666"
        class="bg-[#FF5F00] sm:px-[30px] sm:py-3 px-[25px] py-2 text-white text-[16px] rounded-lg border border-[#ddd] flex gap-2"
