...
<!-- End Google Tag Manager -->
  ...
  <title>Design Pro Labs | Web Offer | Purpose</title>
  ...
  <section class="flex justify-center items-center h-screen ">
    <div class="bg-white sm:p-7 px-0 py-10 rounded-xl border border-[#ddd]">
      ...
      <form id="purposeForm" class="flex flex-col justify-center mt-6">
        <div class="flex sm:justify-center gap-x-8 flex-wrap sm:space-y-0 space-y-3">
          <div class="space-y-3">
            <div class="flex gap-2 items-ceanter">
              <input type="checkbox" id="relying">
              <label for="relying">Relaying information about your business</label>
            </div>
            <div class="flex gap-2 items-center">
              <input type="checkbox" id="ecommerce">
              <label for="ecommerce">Selling (or buying) Online</label>
            </div>
            <div class="flex gap-2 items-center">
          ...
          <div class="space-y-3">
            ...
            <div class="flex gap-2 items-center">
              ...
              <label for="portfolio">Portfolio Showcasing</label>
            </div>
            <div class="flex gap-2 items-center">
