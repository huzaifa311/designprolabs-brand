...
<head>
  ...
  <title>Design Pro Labs | Web Offer | Anything else</title>
...
<body class="hompg bg-[url(../assets/images/stepfrombg.png)] bg-no-repeat bg-cover bg-center">
  ...
  <section class="flex justify-center items-center h-screen ">
    <div class="bg-white sm:p-7 px-0 py-10 rounded-xl border border-[#ddd] md:max-w-[60%]">
      ...
      <h1 class="text-4xl font-bold text-center">
        If there’s anything else that you would like to add, feel free to use the space below
      </h1>
      <form id="anyhtingElseForm" class="flex flex-col justify-center mt-4">
        <input id="anythingElseInput" type="text"
  ...
  <script src="../assets/js/anything.js"></script>
