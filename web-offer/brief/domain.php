...
<head>
  ...
  <title>Design Pro Labs | Web Offer | Domain</title>
...
<body class="hompg bg-[url(../assets/images/stepfrombg.png)] bg-no-repeat bg-cover bg-center">
  ...
  <section class="flex justify-center items-center h-screen">
    <div class="bg-white sm:p-7 px-0 py-10 rounded-xl border border-[#ddd] md:max-w-[55%]">
      ...
      <h1 class="text-4xl font-bold text-center">
        Have You Secured Your Website Domain Yet?
      </h1>
      <form id="domainForm" class="flex flex-col justify-center mt-5">
        <div class="flex justify-center sm:gap-x-10">
          ...
          <div class="flex gap-2 items-center">
            ...
            <input type="text" class="border-b border-b-[#ddd] focus:outline-none" id="domain"
              placeholder="www.designprolabs.com" />
          </div>
        </div>
      </form>
    </div>
  ...
  <div class="fixed bottom-0 left-0 w-full py-4 flex justify-center customBorder bg-white">
    <button id="nextBtn" class="text-lg font-semibold text-white bg-[#FE5F00] py-[10px] px-10 flex items-center gap-2">
      <span>Next</span>
