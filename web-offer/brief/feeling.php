...
<head>
  ...
  <title>Design Pro Labs | Web Offer | Feeling</title>
...
<body class="hompg bg-[url(../assets/images/stepfrombg.png)] bg-no-repeat bg-cover bg-center">
  ...
  <section class="flex justify-center items-center h-screen">
    <div class="bg-white sm:p-7 px-0 py-10 rounded-xl border border-[#ddd] md:max-w-[55%]">
      ...
      <h1 class="text-4xl font-bold text-center">Overall feeling that you would like to portray with your new website
      </h1>
      <form id="feelingForm" class="flex flex-col justify-center mt-5">
        <div class="grid sm:grid-cols-2 sm:gap-x-8">
          <div class="space-y-3">
            ...
            <div class="flex gap-2 items-center">
              <input type="checkbox" id="High-Tech" />
              <label for="High-Tech">High-Tech</label>
            </div>
          </div>
          <div class="space-y-3 sm:ml-auto">
            ...
            <div class="flex gap-2 items-center">
              ...
              <label for="Vintage">Classic (Vintage)</label>
            </div>
            <div class="flex gap-2 items-center">
  ...
  <script src="../assets/js/feeling.js"></script>
