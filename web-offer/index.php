...
<section
  id="home"
  class="sm:!h-[109vh] !h-fit w-full pt-32 relative pb-20 flex items-center"
>
  <div
  ...
  >
    <div class="col-span-3 relative">
      <h1 class="sm:text-5xl text-2xl font-bold text-white md:leading-[55px]">
        Professional Website Development Starting <br />
        From
        <span class="text-[#FE5F00]">$249</span>
        Only
      </h1>
      <p class="text-white mt-2 md:mt-0 text-xl">
        Make a powerful online impact with a custom, user-friendly, and
        professionally designed website tailored to your business needs.
      </p>
      <ul class="space-y-2 my-3">
        <li>
          <div class="flex items-center gap-2">
            <div
              class="h-4 w-4 rounded-full flex items-center justify-center bg-white whitespace-nowrap"
            >
              <img
                src="assets/images/check.png"
                alt="tick"
                class="h-[11px] object-fit"
              />
            </div>
            <p class="text-white text-[15px] font-light">
        ...
        <li>
          <div class="flex items-center gap-2">
            ...
            <p class="text-white text-[15px] font-light">5 Revisions</p>
          </div>
        </li>
        <li>
          <div class="flex items-center gap-2">
      ...
      <div
        class="md:gap-3 mt-3 flex flex-wrap md:justify-start justify-between"
      >
        <div
        ...
        >
          <a href="javascript:;" class="chat hover:!text-white !mt-2"
            >Talk With Expert
          </a>
        </div>
        <a
          ...
          ><button
            style="outline: none"
            class="hover:text-black transition-all hover:!text-white hover:!opacity-90"
          >
    ...
    <form
      onSubmit="handleBannerForm(event, 'BannerFormWebsite')"
    ...
    >
      <h1 class="text-center text-[#FE5F00] text-2xl font-bold mb-3">
        Limited Time Offer
      </h1>
      <div class="space-y-4">
        <div>
        ...
        <div>
          <textarea
            placeholder="Share any specific ideas or requirements you have in mind"
            type="text"
            id="description"
            class="w-full text-black p-3 text-base focus:outline-none border rounded !border-[#C6C6C6] bg-[#F3F3F3]"
          ></textarea>
      ...
      <button
        type="submit"
        class="w-full py-3 text-xl font-medium bg-[#FE5F00] mt-3 rounded-lg text-white"
      >
        Get Started Now
      </button>
      <img
        src="asets/images/blackfriday-tag.jpg"
        alt=""
        class="left-0 -top-11 absolute !z-30"
      />
    </form>
  </div>
...
<section id="portfolio" class="sm:w-[85%] w-[90%] mx-auto my-20 2xl:w-[1500px]">
  ...
  <p class="text-xl mt-1 text-center">
    Browse our expertly crafted website designs, organized by categories to suit
    your business needs.
  </p>
  <ul
    class="flex flex-wrap gap-[10px] items-center justify-center my-4 nav nav-pills"
    id="portfolioTabs"
    role="tablist"
  >
    ...
    <li class="nav-item" role="presentation">
      <button
        ...
        id="tab-Ecommerce"
        data-bs-toggle="pill"
        data-bs-target="#content-Ecommerce"
        type="button"
        role="tab"
        aria-controls="content-Ecommerce"
        aria-selected="false"
      >
        E-Commerce Websites
      </button>
...
>
  <div class="space-y-3">
    ...
    <p class="text-xl">
      Share your vision and choose a package that suits your goals. Let’s craft
    ...
    <div class="flex flex-wrap items-center gap-3 justify-center mt-4">
      <div>
        <a
          href="#pricingSection"
          class="border border-white text-white bg-transparent rounded py-[14px] px-[11px] text-[18px] font-medium text-lg"
          >See Pricing</a
        >
      </div>
      <button
        ...
        data-fancybox=""
        title="Lets Get Started"
        class="py-[14px] px-[11px] text-[18px] font-medium text-lg bg-[#FE5F00] text-white rounded"
      >
        Let's Work Together
      </button>
    </div>
...
<section class="packages-block !mt-20 !p-0" id="pricingSection">
  <div class="sm:w-[85%] w-[90%] mx-auto 2xl:w-[1500px]">
    ...
    <p class="text-center text-wrap -mt-2">
      At
      <span class="text-[#FE5F00] !inline-block !-mt-1">Design Pro Labs,</span>
      we offer high-quality services at prices that work for everyone. Whether
      you're starting small or need the best, our packages are designed to match
      your goals and budget. Choose the plan that fits your needs and let us
      help you create something amazing!
    </p>
  </div>
  <!-- <section class="packages-block !mt-20 !p-0" id="pricingSection"> -->
    <div class="mt-8">
      <div class="!max-w-[74rem] mx-auto shadow-lg">
        <div
        ...
        >
          ...
          <div class="text-center w-full sm:w-1/3 !hover:bg-transparent">
            ...
            <p class="text-5xl font-bold text-orange-600">
              <span class="text-3xl font-semibold">$</span>249
            </p>
            <a
              href="https://www.paypal.com/ncp/payment/JY6SR7PE89PF8"
          ...
          <div
            class="mt-8 md:mt-0 sm:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6 !hover:bg-transparent"
          >
            <div>
              ...
              <ul class="text-sm text-gray-600 space-y-2">
                <li class="flex items-start text-black text-md">
                  <i
                    class="fas fa-check text-[#FE5F00] fa-xs mt-1 mr-2 border border-1 !border-[#FE5F00] px-1 py-2 rounded-full"
                  ></i>
                  1 Page Website
                </li>
            ...
            <div>
              <h4 class="text-lg font-semibold text-gray-800 mb-3">Add-ons</h4>
              <ul class="text-sm text-gray-600 space-y-2">
                <li class="flex items-start text-black">
                  <i
                    class="fas fa-check text-[#FE5F00] fa-xs mt-1 mr-2 border border-1 !border-[#FE5F00] px-1 py-2 rounded-full"
                  ></i>
                  Cross Platform Reponsive Capabilty (Desktop,iPhone, Android,
                  etc) Responsive would Be Additional $100*
                </li>
                <li class="flex items-start text-black">
                  <i
                    class="fas fa-check text-[#FE5F00] fa-xs mt-1 mr-2 border border-1 !border-[#FE5F00] px-1 py-2 rounded-full"
                  ></i
                  >Content Management System (CMS) would Be Additional $100*
                </li>
              </ul>
            </div>
          </div>
          <img
            class="absolute left-0 top-0 h-36"
            src="assets/images/promotional.png"
          />
          <a
...
<section class="sm:w-[85%] w-[90%] mx-auto py-20 2xl:w-[1500px] space-y-10">
  <div class="space-y-5">
    <h2 class="text-3xl mb-3 font-semibold mx-auto w-full text-center">
      Empowering Businesses with Affordable, <br />
      <span class="text-[#FE5F00]"> Custom Website Development.</span>
    </h2>
    <p class="text-center text-wrap">
      At
      <span class="text-[#FE5F00] !inline-block !-mt-1">Design Pro Labs,</span>
      we craft websites that perfectly align with your brand's identity and
      goals. Our skilled developers collaborate with you at every stage to
      deliver unique, high-quality websites at a price that fits your budget.
      Whether you're starting a new venture or revamping your online presence,
      we’ll ensure your website stands out, drives engagement, and delivers
      results.
    </p>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="about-txt-st">
          ...
          <p class="mt-3">
            At
            <span class="text-[#FE5F00] !inline-block !-mt-1"
              >Design Pro Labs,</span
            >
            we empower businesses to thrive with cutting-edge website
            development, creative designs, and strategic digital solutions.
            Based in the U.S., we specialize in custom website creation, mobile
            app development, SEO, and digital marketing. Whether you’re
            establishing your online presence or scaling your brand, our expert
            team is here to turn your vision into reality. Let’s build something
          ...
          <div class="flex gap-6 mt-4">
            ...
            >
              <a href="javascript:;" class="chat banner-btn yb-btn various"
                >Live Chat
              </a>
            </div>
            <a
              ...
              data-src="#popupform"
              ><button style="outline: none">Get in Touch</button></a
            >
          </div>
        </div>
      </div>
        ...
        <div class="about-txt-st">
          ...
          <p class="mt-3">
            ...
            <span class="text-[#FE5F00] !inline-block !-mt-1"
              >Design Pro Labs,</span
            >
            we combine years of experience, creativity, and dedication to
            deliver the best results for our clients. Our talented team focuses
            on providing top-quality services, from website design to website
            development and digital marketing, helping your business grow and
            succeed. We’re here to bring your ideas to life with professionalism
            and care.
          </p>
          <div class="flex gap-6 mt-4">
            <div
...
>
  <div class="space-y-3">
    ...
    <p class="text-xl">
      Contact our expert design team today and let’s bring your ideas to life.
    </p>
    <div class="flex items-center flex-wrap gap-3 justify-center mt-4">
      ...
      <button
        class="border border-white text-white bg-transparent rounded py-[14px] px-[11px] text-[18px] font-medium text-lg chat banner-btn yb-btn various"
      >
        Talk to an Expert
      </button>
      <button
        ...
        <div id="testslider" class="owl-carousel">
          ...
          <div class="test-item grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="max-w-lg p-6">
              <blockquote class="text-[#FE6F19] text-[24px] font-[600]">
                "A Seamless Experience from Start to Finish!"
              </blockquote>
              <p class="mt-4 text-muted-foreground">
                Working with the team was a delight! They took my vague ideas
                and turned them into a vibrant and professional brand identity.
                Every detail was thoughtfully crafted, and their attention to
                detail made all the difference. Highly recommended!
              </p>
              <div class="flex items-center mt-6">
                <img
                  class="w-12 h-12 rounded-full"
                  src="assets/images/barbara.webp"
                  alt="Steven D. Henry"
                />
                <div class="ml-4">
                  <p class="font-medium text-primary-foreground">
                    Sarah J. Miller, Marketing Head
                  </p>
          ...
          <div class="test-item grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="max-w-lg p-6">
              <blockquote class="text-[#FE6F19] text-[24px] font-[600]">
                "Creative, Reliable, and Always On-Time!"
              </blockquote>
              <p class="mt-4 text-muted-foreground">
                From the initial meeting to the final delivery, the team
                showcased professionalism and creativity. They designed a
                website that not only looks stunning but is also highly
                functional. Their commitment to deadlines and client
                satisfaction is unmatched.
              </p>
              <div class="flex items-center mt-6">
                <img
                  class="w-12 h-12 rounded-full"
                  src="assets/images/ashlay.webp"
                  alt="Jane S. Doe"
                />
                <div class="ml-4">
                  <p class="font-medium text-primary-foreground">
                    Michael D. Carter, Owner
                  </p>
          ...
          <div class="test-item grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="max-w-lg p-6">
              <blockquote class="text-[#FE6F19] text-[24px] font-[600]">
                "They Understood Our Vision Perfectly!"
              </blockquote>
              <p class="mt-4 text-muted-foreground">
                We needed a modern, minimalist design for our startup's website,
                and they nailed it! The team understood our vision, worked
                tirelessly, and delivered beyond our expectations. Their ability
                to turn ideas into reality is truly impressive.
              </p>
              <div class="flex items-center mt-6">
                <img
                  class="w-12 h-12 rounded-full"
                  src="assets/images/steven.webp"
                  alt="Mark T. Lee"
                />
                <div class="ml-4">
                  <p class="font-medium text-primary-foreground">
                    Linda K. Williams, Founder
                  </p>
                  <p class="text-sm text-muted-foreground">
                    BlueTrail Ventures
                  </p>
